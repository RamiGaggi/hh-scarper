# Generated by Django 3.2.6 on 2021-08-23 11:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keyword', models.CharField(max_length=100, unique=True, verbose_name='ключевое слово')),
                ('status', models.CharField(choices=[('Pending', 'В процессе'), ('Resolved', 'Готово')], default='Pending', editable=False, max_length=25)),
